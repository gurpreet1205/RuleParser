...
public class RuleParser {
    ...
    SettableParser extractStringComma       = SettableParser.undefined();
    SettableParser extractStringComba       = SettableParser.undefined();

    SettableParser concatStringComma        = SettableParser.undefined();
    SettableParser concatStringCombo        = SettableParser.undefined();
    ...
    SettableParser thenBlock                = SettableParser.undefined();
    SettableParser elseBlock                = SettableParser.undefined();
